...
export const Loans = ()=>{
    ...
    // Current Loans
    const [ shelfCurrentLoans, setShelfCurrentLoans] =
        useState<ShelfCurrentLoans[]>([]);
                            ...
                            <div className={"row mt-3 mb-3"}>
                                <div className={"col-4 col-md-4 container"}>
                                    {
                                        shelfCurrentLoans.book.img?
                                            <img src={shelfCurrentLoans.book?.img} width={"226"} height={"349"}
                                                 alt={"Book"}/>
                                            :
                                ...
                                <div className={"card col-3 col-md-3 container d-flex "}>
                                    <div className={"card-body"}>
                                        ...
                                        <hr/>
                                        <p className={"mt-3 "}>
                                            Help Other Find Their Adventures By Reviewing Your Loan!
                                        </p>
