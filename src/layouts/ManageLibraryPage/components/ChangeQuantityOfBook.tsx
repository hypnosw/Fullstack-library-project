...
export const ChangeQuantityOfBook: React.FC<{book:BookModel, deleteBook:any}> = (props, key)=>{
    ...
    async function increaseQuantity(){
        ...
        const quantityResponse = await fetch(url, requestOptions);
        if(!quantityResponse.ok) throw new Error("Something went wrong in increaseQuantity");
    ...
    async function deleteBook(){
        ...
        if(!deleteResponse.ok) throw new Error("Something went wrong in increaseQuantity");
        ...
        <div className={'card mt-3 shadow p-3 mb-3 bg-body rounded'}>
            <div className={'row g-0'}>
                ...
                <div className={'mt-3 col-md-4'}>
                    ...
                    <div className={'jusity-content-center align-items-center d-flex'}>
