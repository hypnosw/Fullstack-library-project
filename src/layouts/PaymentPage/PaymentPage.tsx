...
export const PaymentPage = ()=>{
    ...
    async function checkout (){
        ...
        if(!stripeResponse.ok){
            ...
            throw  new Error("Something went wrong in checkout payment");
        }
        ...
        stripe.confirmCardPayment(
            ...
            if(result.error){
                ...
                if(!stripeResponse.ok) {
                    setHttpError(true);
                    setSubmitDisabled(false);
                    throw new Error("Something went wrong in stripe Response");
                }
                setFees(0);
                setSubmitDisabled(false);
        ...
        <div className={"container"}>
            {
                ...
                <div className={'card mt-3'}>
                  <h5 className={'card-header'}>Fees pending: <span className={'text-danger'}>
                    ${fees}
                  </span> </h5>
                  <div className={'card-body'}>
                    ...
                    onClick={()=>checkout()}>Pay Fees</button>
                  </div>
                </div>
            }
            {fees === 0 &&
